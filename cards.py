...
class Cards(QDialog):
    ...
    def cards_lots_widgets(self):
        ...
        self.advise_info = QLabel('Ao adicionar um número para o cartão escolha um número Fictício! Não utilize o seu número real.', self)
    ...
    def cards_lots_setting(self):
        ...
        self.card_slot_1_info.setStyleSheet('color:#fff;')
        self.card_slot_2_info.setStyleSheet('color:#fff;')
        self.card_slot_3_info.setStyleSheet('color:#fff;')

    def cards_lots_containers_settings(self):
        self.slot_1.setProperty('class', 'sidebar')
        self.slot_2.setProperty('class', 'sidebar')
        self.slot_3.setProperty('class', 'sidebar')
    ...
    def cards_layout(self):
        ...
        self.main_container.addWidget(self.add_card, alignment=Qt.AlignmentFlag.AlignRight)
        self.main_container.addWidget(self.advise_info, alignment=Qt.AlignmentFlag.AlignCenter)
        self.main_container.addWidget(self.slot_1, alignment=Qt.AlignmentFlag.AlignCenter)
        self.main_container.addWidget(self.slot_2, alignment=Qt.AlignmentFlag.AlignCenter)
        self.main_container.addWidget(self.slot_3, alignment=Qt.AlignmentFlag.AlignCenter)
